...
from themis import Experiment, InMemoryRunStore, RunStore, RunSnapshot, SqliteRunStore, sqlite_store
from themis.core.config import EvaluationConfig, GenerationConfig, StorageConfig
from themis.core.events import RunStartedEvent
from themis.core.models import Case, Dataset


def test_phase1_public_surface_compiles_and_persists_runs(tmp_path) -> None:
    experiment = Experiment(
        ...
        storage=StorageConfig(store="sqlite", parameters={"path": str(tmp_path / "phase1.sqlite3")}),
        datasets=[
            Dataset(
    ...
    sqlite = sqlite_store(tmp_path / "phase1.sqlite3")
