...
import themis
from themis.core.entities import GenerationRecord, GenerationTask, MetricScore, ModelOutput
...
def test_attempt_aware_strategy_preserves_metadata():
    ...
    from themis.core.entities import (
        GenerationTask, GenerationRecord, ModelOutput,
        ModelSpec, SamplingConfig, PromptRender, PromptSpec
    )
    dummy_task = GenerationTask(
        prompt=PromptRender(
            spec=PromptSpec(name="test", template="test"),
            text="test"
        ),
