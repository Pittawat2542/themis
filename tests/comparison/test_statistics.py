...
class TestTTest:
    ...
    def test_t_test_independent_uses_evaluation_stack(self, monkeypatch):
        ...
        def _fake_compare_metrics(
            baseline_scores, treatment_scores, significance_level=0.05
        ):
            calls["count"] += 1
        ...
        monkeypatch.setattr(
            canonical_statistics, "evaluation_compare_metrics", _fake_compare_metrics
        )
...
class TestBootstrap:
    ...
    def test_bootstrap_uses_evaluation_stack_for_default_statistic(self, monkeypatch):
        ...
        monkeypatch.setattr(
            canonical_statistics, "evaluation_bootstrap_ci", _fake_bootstrap_ci
        )
...
class TestPermutation:
    ...
    def test_permutation_significant_difference(self):
        ...
        result = permutation_test(samples_a, samples_b, n_permutations=1000, seed=42)
    ...
    def test_permutation_no_difference(self):
        ...
        result = permutation_test(samples_a, samples_b, n_permutations=100, seed=42)
