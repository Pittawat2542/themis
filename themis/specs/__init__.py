...
_DYNAMIC_EXPORTS = {
    ...
    "TraceScoreSpec": ("themis.benchmark.specs", "TraceScoreSpec"),
    "ModelSpec": ("themis.specs.foundational", "ModelSpec"),
    "ToolSpec": ("themis.specs.foundational", "ToolSpec"),
    "McpServerSpec": ("themis.specs.foundational", "McpServerSpec"),
    ...
    "MetricRefSpec": ("themis.specs.foundational", "MetricRefSpec"),
