...
goal: Route new readers to the right installation, API, storage, and troubleshooting entry points.
---

# Start Here

Use this section when you have not yet built a reliable mental model for Themis or you need help choosing a starting path.
