...
- you want checked-in experiment definitions
...
| --- | --- | --- | --- |
| Python-authored run | You want a reusable experiment definition with compile, run, replay, and store control | More structure than the removed one-call helper | `Experiment(...)`, `Experiment.compile()`, `Experiment.run()` |
| Config and CLI workflow | You want checked-in specs and shell automation | Component references must be importable or builtin ids | `Experiment.from_config(...)`, `themis run`, `themis submit` |
