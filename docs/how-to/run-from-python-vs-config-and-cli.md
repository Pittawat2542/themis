...
| --- | --- | --- | --- |
| Ad hoc scripts and notebooks | You want direct imports, live objects, and quick local debugging | Harder to standardize across repeated runs | Python authoring with `Experiment(...)`, `Experiment.run()`, and `Experiment.run_async()` |
