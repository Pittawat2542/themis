...
| `suite list|inspect|run` | Discovers and executes suite definitions | You want named groups like `math-core` or `general-core` | Suite membership is stored as tags/metadata, not a replacement identity |
