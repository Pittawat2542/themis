...
| `Reporter`, `FailureSlice`, `FailureSliceSummary`, `ReliabilitySummary`, `RegressionPolicy`, `RegressionFinding`, `RegressionSummary`, `TrendPoint`, `TrendView`, `StatsEngine` | Reporting and analysis | You need summaries, slices, trends, regressions, or paired comparisons | Comparisons use canonical dataset-scoped case keys |
