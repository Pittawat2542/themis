...
When it matters: whenever `Generation.samples` is greater than one or metrics need a parsed shape that differs from raw model output.

What you provide: generation sampling settings, an optional reducer, an optional parser, and metrics.
