# Themis vNext Examples

These examples use the vNext flow: `ExperimentSpec` + `ExperimentSession.run(...)`.
...
- `06_custom_metrics.py`: custom metric class in a vNext pipeline.
