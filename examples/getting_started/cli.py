"""CLI wrapper for the example experiment."""
...
app = App(help="Run the example Themis experiment")
...
def _load_config(path: Path | None) -> ExampleExperimentConfig:
    if path is None:
        return DEFAULT_CONFIG
    return load_config(path)


def _print_plan_summary(config: ExampleExperimentConfig) -> None:
